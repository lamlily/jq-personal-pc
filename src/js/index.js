jQuery($=>{
    ...
    if(username){
        ...
        $('.advertisement').on('click',function(e){
           ...
           location.href='http://localhost:8090/html/goodlists.html?username='+username+'&name='+params;
        });
    ...
    // 跳到详情页
        $('.flashsale').delegate('.ToDetail','click',function(e){
            let id=$(this).closest('li').attr('id');
            id=encodeURI(id);
            console.log(id);
           location.href='http://localhost:8090/html/detail.html?username='+username+'&id='+id;
        });
    ...
    // 跳到结算页面
        $('.ToCheckout').click(function() {
           location.href='http://localhost:8090/html/shoppingCar.html?username='+username;
        });
        ...
        // 跳到列表页
            $('.nav-category').on('click',function(e){
                let params=encodeURI(this.innerText);
               location.href='http://localhost:8090/html/goodlist.html?name='+params;
                // location.href='http://localhost:8090/html/goodlists.html?name='+params;
            });
        ...
        // 跳到列表页
         ...
         // 跳到列表页
            $('.sasa_mustcheck').on('click',function(e){
                let params=encodeURI(this.innerText);
               location.href='http://localhost:8090/html/goodlist.html?name='+params;
                // location.href='http://localhost:8090/html/goodlists.html?name='+params;
            });
        ...
        // 跳到详情页
            $('.newarrivals-rs').delegate('.ToDetail','click',function(e){
                let id=$(this).closest('li').attr('id');
                id=encodeURI(id);
                console.log(id);
               location.href='http://localhost:8090/html/detail.html';
                // location.href='http://localhost:8090/html/detail.html?id='+id;
            });

        // 跳到详情页
            $('#index_seckill_514_container').delegate('.ToDetail','click',function(e){
                let id=$(this).closest('li').attr('id');
                id=encodeURI(id);
                console.log(id);
               location.href='http://localhost:8090/html/detail.html';
        ...
        // 跳到结算页面
            $('.ToCheckout').click(function() {
               location.href="http://localhost:8090/html/login.html";
                // location.href="http://localhost:8090/html/login.html";
            });
    }
